...
def OCR(num_class, drop_rate = 0.5, num_layer = 2, num_units = 512):
  ...
  inputs = tf.keras.Input((32, None, 1)); # inputs.shape = (batch, 32, seq_length, 1)
  results = tf.keras.layers.Lambda(lambda x: tf.transpose(x, (0, 2, 1, 3)))(inputs); # results.shape = (batch, seq_length, 32, 1)
